...
<Package name="Pepper_COE" format_version="5">
    ...
    <Topics>
        ...
        <Topic name="CollegeOfChemicalEngineering_enu" src="CollegeOfChemicalEngineering/CollegeOfChemicalEngineering_enu.top" topicName="CollegeOfChemicalEngineering" language="en_US" nuance="enu" />
        <Topic name="CollegeOfEngineeringTechnology_enu" src="CollegeOfEngineeringTechnology/CollegeOfEngineeringTechnology_enu.top" topicName="CollegeOfEngineeringTechnology" language="en_US" nuance="enu" />
        <Topic name="CollegeOfComputerScience_enu" src="CollegeOfComputerScience/CollegeOfComputerScience_enu.top" topicName="CollegeOfComputerScience" language="en_US" nuance="enu" />
